...
use \Exception;
use \PDO;
use PropelModels\Author as ChildAuthor;
use PropelModels\AuthorQuery as ChildAuthorQuery;
use PropelModels\Map\AuthorTableMap;
 ...
 *
 * @method     \PropelModels\BookQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \PropelModels\Base\AuthorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\PropelModels\\Author', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name FROM authors WHERE id = :p0';
        try {
    ...
    /**
     * Filter the query by a related \PropelModels\Book object
     *
     * @param \PropelModels\Book|ObjectCollection $book the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($book instanceof \PropelModels\Book) {
            return $this
            ...
            throw new PropelException('filterByBook() only accepts arguments of type \PropelModels\Book or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \PropelModels\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\PropelModels\BookQuery');
    }
