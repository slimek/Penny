...
use PropelModels\Author;
use PropelModels\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModels.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\PropelModels\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModels.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelModels\\Author');
    ...
    {
        $this->addRelation('Book', '\\PropelModels\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelModels\Author) { // it's a model object
