...
use PropelModels\Book;
use PropelModels\BookQuery;
...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModels.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\PropelModels\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModels.Book';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'AuthorId', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'authorId', ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID, BookTableMap::COL_TITLE, BookTableMap::COL_AUTHOR_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'author_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'AuthorId' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'authorId' => 2, ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID => 0, BookTableMap::COL_TITLE => 1, BookTableMap::COL_AUTHOR_ID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'author_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelModels\\Book');
    ...
    {
        $this->addRelation('Author', '\\PropelModels\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelModels\Book) { // it's a model object
